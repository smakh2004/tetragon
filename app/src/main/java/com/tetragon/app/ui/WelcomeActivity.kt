...
class WelcomeActivity : BaseActivity() {
    ...
    private fun setupUI() {
        ...
        // Setting static text from strings.xml
        binding.tetragonText.text = getString(R.string.tetragon)
        binding.tetragonDescriptionText.text = getString(R.string.learn_with_joy)
        binding.offlineText.text = getString(R.string.you_are_offline) // Assuming ID for "YOU ARE OFFLINE"
    }
