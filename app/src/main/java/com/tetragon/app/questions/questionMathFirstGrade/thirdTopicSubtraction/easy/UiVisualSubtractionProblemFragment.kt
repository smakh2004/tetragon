...
class UiVisualSubtractionProblemFragment : Fragment(R.layout.fragment_ui_visual_subtraction_problem) {
    ...
    private var appleValue = 0   // subtrahend
    private var grapeValue = 0   // minuend
    ...
    private fun generateProblem() {
        // grape is the minuend (larger), apple the subtrahend, so grape - apple is positive.
        grapeValue = Random.Default.nextInt(2, 11)       // 2..10
        appleValue = Random.Default.nextInt(1, grapeValue) // 1..grapeValue-1
    ...
    private fun checkAnswer(index: Int) {
        ...
        if (chosen == correctAnswer) {
            ...
            if (isFirstAttempt) {
                activity.totalXp += MathGrade1Type.SUBTRACTION_VISUAL_PROBLEM.xp
            }
