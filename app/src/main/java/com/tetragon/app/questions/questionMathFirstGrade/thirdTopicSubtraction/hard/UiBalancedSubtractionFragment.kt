...
class UiBalancedSubtractionFragment : Fragment(R.layout.fragment_ui_balanced_subtraction) {
    ...
    private fun generateProblem() {
        // Balance / equivalence: a - b = ? - c   (e.g. 9 - 4 = _ - 2)
        // Both sides equal the same difference d.
        val d = Random.Default.nextInt(1, 9)  // common difference 1..8
        val b = Random.Default.nextInt(1, 8)  // 1..7
        val a = d + b                          // left side: a - b = d
        val c = Random.Default.nextInt(1, 8)  // known right-side subtrahend 1..7
        correctAnswer = d + c                  // missing minuend: ? - c = d  =>  ? = d + c
    ...
    private fun checkAnswer(index: Int, stateContainer: FrameLayout, circleState: ImageView) {
        ...
        if (chosen == correctAnswer) {
            ...
            if (isFirstAttempt) {
                activity.totalXp += MathGrade1Type.SUBTRACTION_BALANCED.xp
            }
