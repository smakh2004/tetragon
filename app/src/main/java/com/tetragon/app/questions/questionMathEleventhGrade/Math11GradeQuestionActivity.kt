package com.tetragon.app.questions.questionMathEleventhGrade
...
import com.tetragon.app.databinding.ActivityMath11GradeQuestionBinding
...
import com.tetragon.app.questions.questionMathEleventhGrade.firstTopic.UiDerivativesProblemFragment
import com.tetragon.app.utils.languageChangeUtils.BaseActivity
import com.google.android.material.bottomsheet.BottomSheetDialog
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class Math11GradeQuestionActivity : BaseActivity() {

    private lateinit var binding: ActivityMath11GradeQuestionBinding
    private lateinit var selectedTopic: MathGrade11Topic
    private var lastQuestionType: MathGrade11Type? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Rive.init(this)
        binding = ActivityMath11GradeQuestionBinding.inflate(layoutInflater)
        ...
        // Using Grade 11 Enum
        selectedTopic = MathGrade11Topic.valueOf(topicName)
    ...
    // Mapping for Grade 11 Topics
    private fun getTypesForTopic(topic: MathGrade11Topic): List<MathGrade11Type> {
        return when (topic) {
            MathGrade11Topic.DERIVATIVES -> listOf(
                MathGrade11Type.DERIVATIVES_PROBLEM
            )
        }
    }
    ...
    fun showRandomQuestion() {
        ...
        // Fragment mapping for Grade 11
        val fragment = when (nextType) {
            MathGrade11Type.DERIVATIVES_PROBLEM -> UiDerivativesProblemFragment()
        }
    ...
    fun navigateToXpGained() {
        val intent = Intent(this, XpGainedActivity::class.java).apply {
            ...
            putExtra(SubjectConstants.EXTRA_GRADE, 11) // Updated to 11
    ...
    private fun showQuitBottomSheet() {
        ...
        // 2. Use getString() with your resource IDs
