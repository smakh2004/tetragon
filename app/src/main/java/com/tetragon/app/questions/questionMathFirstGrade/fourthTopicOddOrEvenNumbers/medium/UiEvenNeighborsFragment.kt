...
class UiEvenNeighborsFragment : Fragment(R.layout.fragment_ui_even_neighbors) {

    private lateinit var instructionText: TextView
    private lateinit var middleText: TextView

    // Two blanks: [before] , middle , [after]
    ...
    private var correct = IntArray(SLOT_COUNT) // [before, after]
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        initViews(view)
        instructionText.text = getString(R.string.instruction_even_neighbors)
    ...
    private fun initViews(view: View) {
        ...
        middleText = view.findViewById(R.id.middleText)
    ...
    private fun generateProblem() {
        // Middle is even (4..16). Even neighbors are middle-2 and middle+2.
        val middle = Random.nextInt(2, 9) * 2   // 4,6,...,16
        val before = middle - 2
        val after = middle + 2
        correct[0] = before
        correct[1] = after
        ...
        // Distractors are the ODD immediate neighbors (middle-1, middle+1) — the classic trap.
        val distractors = listOf(middle - 1, middle + 1)
        tileValues = (listOf(before, after) + distractors).shuffled()
    ...
    private fun checkAnswer(stateContainer: FrameLayout, circleState: ImageView) {
        ...
        // Position-specific: before on the left, after on the right (keeps 6, 8, 10 order).
        val allRight = (0 until SLOT_COUNT).all { slotValue[it] == correct[it] }
        ...
        if (allRight) {
            ...
            if (isFirstAttempt) activity.totalXp += MathGrade1Type.EVEN_NEIGHBORS.xp
    ...
    private fun solutionString(): String = "${correct[0]}, ${middleText.text}, ${correct[1]}"
    ...
    private fun setupSeeSolution(stateContainer: FrameLayout, circleState: ImageView) {
        seeEnabledButton.setOnClickListener {
            ...
            for (i in 0 until SLOT_COUNT) showSlotFilled(i, correct[i])
