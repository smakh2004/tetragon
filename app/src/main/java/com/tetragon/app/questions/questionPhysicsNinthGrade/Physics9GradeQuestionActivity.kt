...
import com.tetragon.app.databinding.ActivityPhysics9GradeQuestionBinding
...
import com.tetragon.app.questions.questionPhysicsNinthGrade.firstTopic.UiFindForceFragment
import com.tetragon.app.utils.languageChangeUtils.BaseActivity
import com.google.android.material.bottomsheet.BottomSheetDialog
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class Physics9GradeQuestionActivity : BaseActivity() {

    private lateinit var binding: ActivityPhysics9GradeQuestionBinding
    private lateinit var selectedTopic: PhysicsGrade9Topic

    private var lastType: PhysicsGrade9Type? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPhysics9GradeQuestionBinding.inflate(layoutInflater)
        ...
        val topicName = intent.getStringExtra("TOPIC_KEY")
            ?: throw IllegalArgumentException("TOPIC_KEY missing for Grade 9 Physics")

        selectedTopic = PhysicsGrade9Topic.valueOf(topicName)
    ...
    private fun getTypesForTopic(topic: PhysicsGrade9Topic): List<PhysicsGrade9Type> {
        return when (topic) {
            PhysicsGrade9Topic.NEWTONS_LAW -> listOf(PhysicsGrade9Type.FIND_FORCE)
        }
    }
    ...
    fun showRandomQuestion() {
        ...
        val fragment = when (nextType) {
            PhysicsGrade9Type.FIND_FORCE -> UiFindForceFragment()
        }
