...
import com.tetragon.app.questions.questionMathFifthGrade.firstTopic.UiAdditionNaturalNumbersFragment
...
class Math5GradeQuestionActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Using a 5th Grade specific Enum
    ...
    private fun getTypesForTopic(topic: MathGrade5Topic): List<MathGrade5Type> {
        return when (topic) {
            MathGrade5Topic.NATURAL_NUMBERS -> listOf(MathGrade5Type.ADDITION_NATURAL_NUMBERS)
        }
    }
    ...
    fun navigateToXpGained() {
        val intent = Intent(this, XpGainedActivity::class.java).apply {
            ...
            putExtra(SubjectConstants.EXTRA_GRADE, 5) // Updated for Grade 5
