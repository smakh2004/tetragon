package com.tetragon.app.questions.questionMathFirstGrade.thirdTopicSubtraction
...
class UiRepresentSubtractionOfTwoNumbersFragment :
    ...
    private fun generateProblem() {
        ...
        while (optionSet.size < 3) {
            val fakeMinuend = Random.nextInt(2, 11)
            val fakeSubtrahend = Random.nextInt(1, fakeMinuend)
