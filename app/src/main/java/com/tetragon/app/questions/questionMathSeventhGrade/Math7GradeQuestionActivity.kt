...
import com.tetragon.app.databinding.ActivityMath7GradeQuestionBinding
...
import com.tetragon.app.questions.questionMathSeventhGrade.firstTopic.UiIntegerArithmeticsFragment
import com.tetragon.app.utils.languageChangeUtils.BaseActivity
import com.google.android.material.bottomsheet.BottomSheetDialog
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class Math7GradeQuestionActivity : BaseActivity() {

    private lateinit var binding: ActivityMath7GradeQuestionBinding
    private lateinit var selectedTopic: MathGrade7Topic
    private var lastQuestionType: MathGrade7Type? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Rive.init(this)
        binding = ActivityMath7GradeQuestionBinding.inflate(layoutInflater)
        ...
        // Using Grade 7 Enum
        selectedTopic = MathGrade7Topic.valueOf(topicName)
    ...
    private fun getTypesForTopic(topic: MathGrade7Topic): List<MathGrade7Type> {
        return when (topic) {
            MathGrade7Topic.INTEGERS -> listOf(
                MathGrade7Type.INTEGERS_ARITHMETICS
            )
        }
    }
    ...
    fun showRandomQuestion() {
        ...
        // Placeholder Fragments for Grade 7
        val fragment = when (nextType) {
            MathGrade7Type.INTEGERS_ARITHMETICS -> UiIntegerArithmeticsFragment()
        }
    ...
    fun navigateToXpGained() {
        val intent = Intent(this, XpGainedActivity::class.java).apply {
            ...
            putExtra(SubjectConstants.EXTRA_GRADE, 7) // Updated for Grade 7
