...
import com.tetragon.app.databinding.ActivityMath4GradeQuestionBinding
...
import com.tetragon.app.questions.questionMathFourthGrade.fifthTopic.*
import com.tetragon.app.questions.questionMathFourthGrade.firstTopic.*
import com.tetragon.app.questions.questionMathFourthGrade.fourthTopic.*
import com.tetragon.app.questions.questionMathFourthGrade.secondTopic.*
import com.tetragon.app.questions.questionMathFourthGrade.thirdTopic.*
import com.tetragon.app.questions.questionMathThirdGrade.fifthTopic.UiFindXYFragment
...
class Math4GradeQuestionActivity : BaseActivity() {
    ...
    private fun getTypesForTopic(topic: MathGrade4Topic): List<MathGrade4Type> {
        return when (topic) {
            MathGrade4Topic.COMPLEX_ARITHMETICS -> listOf(MathGrade4Type.ADDITION, MathGrade4Type.SUBTRACTION)
            MathGrade4Topic.COLUMN_MULTIPLICATION -> listOf(MathGrade4Type.MULTIPLICATION)
            MathGrade4Topic.COLUMN_DIVISION -> listOf(MathGrade4Type.DIVISION)
            MathGrade4Topic.FRACTION_ARITHMETICS -> listOf(MathGrade4Type.FRACTION)
            MathGrade4Topic.MIXED_NUMBERS -> listOf(MathGrade4Type.MIXED_NUMBERS_ARITHMETICS)
            MathGrade4Topic.GRAPHS -> listOf(MathGrade4Type.FIND_X_Y)
        }
    }
    ...
    fun showRandomQuestion() {
        ...
        val fragment = when (nextType) {
            ...
            MathGrade4Type.FIND_X_Y -> UiFindXYFragment()
        }
    ...
    fun navigateToXpGained() {
        val intent = Intent(this, XpGainedActivity::class.java).apply {
            ...
            putExtra(SubjectConstants.EXTRA_GRADE, 4)
