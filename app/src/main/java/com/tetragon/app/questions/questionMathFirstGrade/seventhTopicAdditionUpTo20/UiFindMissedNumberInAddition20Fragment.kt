...
class UiFindMissedNumberInAddition20Fragment : Fragment(R.layout.fragment_ui_find_missed_number_in_addition20) {
    ...
    private fun generateProblem() {
        val operator = '+'
        val result = Random.nextInt(2, 21)
        val firstNumber = Random.nextInt(1, result)
    ...
    private fun checkAnswer(index: Int, stateContainer: FrameLayout, circleState: ImageView) {
        ...
        if (chosen == correctAnswer) {
            ...
            if (isFirstAttempt) activity.totalXp += MathGrade1Type.ADDITION_MISSED_NUMBER_20.xp
