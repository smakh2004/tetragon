package com.tetragon.app.questions.questionMathSecondGrade.sixthTopic
...
class UiTimeArithmeticsFragment : Fragment(R.layout.fragment_ui_time_arithmetics) {

    private lateinit var timeProblemText: TextView
    ...
    private var targetHours: Int = 0
    private var extraMinutes: Int = 0
    private var correctAnswerTotalMin: Int = 0
    ...
    private fun checkAnswer() {
        ...
        if (userValue == correctAnswerTotalMin) {
    ...
    private fun setupSeeSolution() {
        seeEnabledButton.setOnClickListener {
            ...
            problemAnswerText.text = correctAnswerTotalMin.toString()
            riveAnimation.setBooleanState(STATE_MACHINE, INPUT_ANSWERED, true)

            val correctIdx = optionMapping.filterValues { it == correctAnswerTotalMin }.keys.firstOrNull()?.toFloat() ?: 1f
    ...
    private fun initViews(view: View) {
        ...
        problemAnswerText = view.findViewById(R.id.timeAnswerValue)
