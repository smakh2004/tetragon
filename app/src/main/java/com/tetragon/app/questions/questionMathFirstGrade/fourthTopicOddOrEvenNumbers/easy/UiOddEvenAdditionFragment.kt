...
class UiOddEvenAdditionFragment : Fragment(R.layout.fragment_ui_odd_even_addition) {
    ...
    private fun generateProblem() {
        val a = Random.Default.nextInt(1, 10) // 1..9
        val b = Random.Default.nextInt(1, 10) // 1..9
        result = a + b                        // 2..18
    ...
    private fun checkAnswer(index: Int) {
        ...
        if (chosenLabel == correctLabel) {
            ...
            if (isFirstAttempt) {
                activity.totalXp += MathGrade1Type.ADDITION_ODD_EVEN.xp
            }
