package com.tetragon.app.questions.questionMathFirstGrade.fifthTopicComparison
...
class UiComparisonNumbersFragment : Fragment(R.layout.fragment_ui_comparison_numbers) {
    ...
    private fun setupInstructionText() {
        val wordToStyle = getString(R.string.instruction_sign_word)
        val fullText = getString(R.string.instruction_put_sign, wordToStyle)
    ...
    private fun generateProblem() {
        ...
        when (problemType) {
            0 -> { // ADDITION
                ...
                val b = leftValue - a
                firstNumber.text = getString(R.string.math_format_addition, a, b)

                rightValue = Random.nextInt(2, 11)
                val c = Random.nextInt(1, rightValue)
                val d = rightValue - c
                secondNumber.text = getString(R.string.math_format_addition, c, d)
            }
            1 -> { // SUBTRACTION
                val a = Random.nextInt(1, 11)
                val b = Random.nextInt(0, a + 1)
                leftValue = a - b
                firstNumber.text = getString(R.string.math_format_subtraction, a, b)

                val c = Random.nextInt(1, 11)
                val d = Random.nextInt(0, c + 1)
                rightValue = c - d
                secondNumber.text = getString(R.string.math_format_subtraction, c, d)
            }
            else -> { // SIMPLE NUMBERS
