...
class UiParenthesesMissedTwoDigitNumbersFragment : Fragment(R.layout.fragment_ui_parentheses_missed_two_digit_numbers) {
    ...
    private fun generateProblem() {
        ...
        if (isAddition) {
            op1 = "+"
            op2 = "+"
            finalResult = Random.nextInt(20, 101)
            a = Random.nextInt(5, finalResult - 10)
            val remaining = finalResult - a
            b = Random.nextInt(5, remaining - 2)
            c = finalResult - a - b
        } else {
            if (useParenthesesAtEnd) {
                a = Random.nextInt(40, 101)
                val innerSum = Random.nextInt(10, a - 5)
                b = Random.nextInt(5, innerSum - 2)
                c = innerSum - b
                finalResult = a - innerSum
                op1 = "-"
                op2 = "+"
            } else {
                a = Random.nextInt(40, 101)
                b = Random.nextInt(10, a - 10)
                val firstStep = a - b
                c = Random.nextInt(5, firstStep - 2)
                finalResult = firstStep - c
                op1 = "-"
                op2 = "-"
            }
        }
    ...
    private fun setupOptions() {
        ...
        while (optionSet.size < 3) {
            optionSet.add(Random.nextInt(1, 101)) // Distractors within 2-digit range
        }
    ...
    private fun checkAnswer(index: Int, stateContainer: FrameLayout, circleState: ImageView) {
        ...
        if (chosen == correctAnswer) {
            ...
            if (isFirstAttempt) {
                activity.totalXp += MathGrade1Type.PARENTHESES_MISSED_TWO_DIGIT_NUMBERS.xp
            }
