...
class Math9GradeFragment : Fragment() {
    ...
    private lateinit var backToGrade8Btn: View
    ...
    // Grade 9 Topics
    private val topicNames = listOf("Quadratic Equations")
    private val topicKeys = listOf("QUADRATIC_EQUATIONS")

    // --- GRADE 10 DATA FOR DYNAMIC PREVIEW ---
    private val grade10TopicNames = listOf("Trigonometry")
    private val grade10TopicKeys = listOf("TRIGONOMETRY")
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        return inflater.inflate(R.layout.fragment_math9_grade, container, false)
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // --- GO BACK (To Grade 8) ---
        backToGrade8Btn.setOnClickListener {
            val intent = Intent(requireContext(), MainActivity::class.java).apply {
    ...
    private fun initViews(view: View) {
        ...
        backToGrade8Btn = view.findViewById(R.id.back_to_prev_grade_btn)
    ...
    private fun setupRiveTopics() {
        setupSingleTopic(topic1, R.raw.progress_path_odd, 1f, "QUADRATIC_EQUATIONS")
    }
    ...
    private fun listenToTopicProgress() {
        ...
        topicProgressListener = db.collection("users").document(user.uid).addSnapshotListener { snapshot, _ ->
            ...
            topicKeys.forEachIndexed { index, key ->
                val prog = (progressMap9[key] as? Long ?: 0).toFloat()
                val claimed = claimedMap9[key] as? Boolean ?: false
            ...
            currentTargetIndex = findTargetTopicIndex(progressMap9, topicKeys, claimedMap9)

            // 2. DYNAMIC PREVIEW FOR GRADE 10
            ...
            val activeGrade10Index = findTargetTopicIndex(progressMap10, grade10TopicKeys, claimedMap10)
            val activeTopicName10 = grade10TopicNames.getOrNull(activeGrade10Index) ?: grade10TopicNames[0]

            nextTopicName.text = "Topic ${activeGrade10Index + 1}: $activeTopicName10"
    ...
    private fun handleRewardClaimed(view: RiveAnimationView, topicKey: String) {
        ...
        db.collection("users").document(user.uid)
            .update("claimedRewardsMath9.$topicKey", true)
    ...
    private fun handleContinueClick() {
        ...
        if (pendingRewardKey != null) {
            ...
            // Target the 9th Grade Question Activity (Assumed naming convention)
            val intent = Intent(requireContext(), Math9GradeQuestionActivity::class.java).apply {
