...
class UiRepresentSumOfTwoNumbersFragment :
            ...
            if (!isAnswerChecked) {
                ...
                if (isIncorrectAttempt) {
                    ...
                    if (checkBtn.text == "FINISH") {
                        ...
                        // GATE: Check for milestones before moving to the next problem
    ...
    private fun checkAnswer(index: Int, stateContainer: FrameLayout, circleState: ImageView) {
        ...
        if (isCorrect) {
            ...
            // 1. Play the Rive animation for Mr. Square
            ...
            // 2. Log the milestone progress in the Activity
    ...
    private fun resetUIForNext() {
        val activity = requireActivity() as Math1GradeQuestionActivity
        activity.isResultCurrentlyVisible = false
        activity.hideSuccessAnimation() // Clear animation
