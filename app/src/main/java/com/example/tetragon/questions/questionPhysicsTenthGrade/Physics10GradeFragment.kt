...
class Physics10GradeFragment : Fragment() {
    ...
    private val topicNames = listOf("Magnetism")
    private val topicKeys = listOf("MAGNETISM")

    // --- GRADE 11 TOPIC DATA FOR JUMP AHEAD ---
    private val grade11TopicNames = listOf("Modern Physics")
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Navigation to Grade 11
        moveOnBtn.setOnClickListener {
            navigateToGrade(11, "PHYSICS", R.anim.slide_in_right, R.anim.slide_out_left)
        }

        // Navigation to Grade 9
        backToPrevGradeBtn.setOnClickListener {
            navigateToGrade(9, "PHYSICS", R.anim.slide_in_left, R.anim.slide_out_right)
        }
    ...
    private fun listenProgress() {
        ...
        listener = db.collection("users").document(user.uid).addSnapshotListener { snap, _ ->
            ...
            nextTopicName.text = "Topic ${activeIndex11 + 1}: ${grade11TopicNames.getOrElse(activeIndex11) { grade11TopicNames[0] }}"
