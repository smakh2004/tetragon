...
class UiComparisonThreeDigitNumbersFragment : Fragment(R.layout.fragment_ui_comparison_three_digit_numbers) {
    ...
    private fun checkAnswer(index: Int, stateContainer: FrameLayout, circleState: ImageView) {
        ...
        if (chosen == correctAnswer) {
            ...
            if (isFirstAttempt) activity.totalXp += MathGrade2Type.COMPARISON_THREE_DIGITS.xp
