...
class Math4GradeFragment : Fragment() {
    ...
    private fun setupRiveTopics() {
        setupSingleTopic(topic1, R.raw.progress_path_odd, 1f, "COMPLEX_ARITHMETICS")
        setupSingleTopic(topic2, R.raw.progress_path_even, 2f, "COLUMN_MULTIPLICATION")
        setupSingleTopic(topic3, R.raw.progress_path_odd, 3f, "COLUMN_DIVISION")
        setupSingleTopic(topic4, R.raw.progress_path_even, 4f, "FRACTION_ARITHMETICS")
        setupSingleTopic(topic5, R.raw.progress_path_odd, 5f, "MIXED_NUMBERS")
    }
    ...
    private fun handleRewardClaimed(view: RiveAnimationView, topicKey: String) {
        ...
        db.collection("users").document(user.uid)
            .update("claimedRewardsMath4.$topicKey", true)
