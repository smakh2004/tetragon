...
import com.example.tetragon.databinding.ActivityMath6GradeQuestionBinding
...
import com.example.tetragon.questions.questionMathSixthGrade.firstTopic.UiFractionsAdditionFragment
import com.google.android.material.bottomsheet.BottomSheetDialog
import kotlinx.coroutines.delay
import kotlinx.coroutines.launch

class Math6GradeQuestionActivity : AppCompatActivity() {
    ...
    private fun getTypesForTopic(topic: MathGrade6Topic): List<MathGrade6Type> {
        return when (topic) {
            MathGrade6Topic.FRACTIONS -> listOf(
                MathGrade6Type.ADDITION_FRACTIONS
            )
        }
    }
    ...
    fun showRandomQuestion() {
        ...
        // Placeholder Fragments for Grade 6 - Replace with your actual Fragment classes
    ...
    fun navigateToXpGained() {
        val intent = Intent(this, XpGainedActivity::class.java).apply {
            ...
            putExtra(SubjectConstants.EXTRA_GRADE, 6) // Updated for Grade 6
